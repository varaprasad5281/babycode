  ...
  return (
    <div className="w-full lg:max-h-screen overflow-scroll pb-5 bg-background ">
      ...
      <div className="bg-white">
        <div
          className="flex gap-2 items-center px-6 py-3 text-xl lg:hidden cursor-pointer w-fit"
      ...
      <main className="lg:pt-[2.1rem] px-5 md:px-8">
        <div className="hidden lg:flex items-center gap-2">
          ...
          {/* <p className="text-primary-500">{subcategory || category}</p> */}
          <Link to={`/writing/${category}`} className={"text-primary-500"}>
            {category}
          </Link>{" "}
        </div>
